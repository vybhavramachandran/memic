...
PYBIND11_MODULE(pybBioGearsEngine, m) {
    ...
    .def("LoadState",py::overload_cast<const char*, const biogears::SEScalarTime* >(&biogears::BioGearsEngine::LoadState))
    ...
    .def("AdvanceModelTime",py::overload_cast<bool>(&biogears::BioGearsEngine::AdvanceModelTime))
    .def("AdvanceModelTime",py::overload_cast<double, const biogears::TimeUnit&, bool>(&biogears::BioGearsEngine::AdvanceModelTime))
