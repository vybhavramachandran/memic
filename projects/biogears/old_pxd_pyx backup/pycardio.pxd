...
cdef extern from "projects/biogears/libBiogears/include/biogears/cdm/properties/SEScalar.h" namespace "biogears":
...
cdef extern from "projects/biogears/libBiogears/include/biogears/cdm/system/physiology/SECardiovascularSystem.h" namespace "biogears":
    cdef cppclass SECardiovascularSystem:
        SECardiovascularSystem(Logger *logger)
        
        SEScalar GetScalar(const char* name)
        ...
        #double GetArterialPressure(const PressureUnit& unit) 
